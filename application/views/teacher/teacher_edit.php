<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('teacher/edit/'.$edit['id']); ?>">Profil</a></li>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open_multipart('teacher/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        <div class="btn-group pull-left"><a href="<?php echo base_url('teacher') ?>" class="btn btn-danger btn-sm" > Cancel</a>
