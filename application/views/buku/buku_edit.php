    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open_multipart('buku/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    <p class="col-sm-2 text-left">Genre </p>

                    <div class="col-sm-10">
                        <input type="text" name="genre" class="form-control" placeholder="Genre" value="<?php echo $edit['genre']; ?>">
                    </div>
                </div>

                <div class="form-group">
                    <p class="col-sm-2 text-left">Posisi Rak </p>

                    <div class="col-sm-10">
                        <input type="text" name="rak" class="form-control" placeholder="Posisi Rak" value="<?php echo $edit['rak']; ?>">
                    </div>
                </div>


                <div class="form-group">
                    <p class="col-sm-2 text-left">Stok </p>

                    <div class="col-sm-10">
                        <input type="number" name="stok" class="form-control" placeholder="Stok" value="<?php echo $edit['stok']; ?>">
                    </div>
                </div>
