        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open_multipart('buku/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="genre" class="form-control" placeholder="Genre" value="<?php echo set_value('genre'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="rak" class="form-control" placeholder="Posisi Rak" value="<?php echo set_value('rak'); ?>">
                    </div>
                </div>
