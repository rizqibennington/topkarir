...
<div class="row">
    <div class="col-lg-12">
        <?php echo anchor('buku/create', 'Add', array('class' => 'btn btn-success btn-sm')); ?>
        <br /><br />
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <a href="<?php echo base_url('buku/edit/'.$row->kode_buku) ?>" class="btn btn-warning btn-sm" name="edit"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                                <a href="#" name="<?php echo $row->judul;?>" class="btn btn-danger btn-sm" kode="<?php echo $row->kode_buku;?>"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                            </td>
                                    </tr>
                                <?php $no++; } ?>    
                                </tbody>
