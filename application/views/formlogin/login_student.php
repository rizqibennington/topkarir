...
<head>
    ...
    <title>Login | Top Karir Indonesia!</title>
...
<div class="row">
    <div class="col-md-4">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span class="glyphicon glyphicon-lock"></span> <strong>LOGIN STUDENT</strong>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo site_url('login_student');?>" method="post">
    ...
    <div class="col-md-8 ">
        <h4> Selamat datang di Top Karir Indonesia!</h4><hr class="line-title"> 
        <img src="<?php echo base_url(); ?>assets/img/banner/topkarir.jpg" alt="Belum Tersedia" class="img-responsive">
    </div>
</div>
</div>
